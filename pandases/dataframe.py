...
from pandases.queries import Agg, Select
from pandases.operators import *
from pandases.types import Column, Row
from pandases.errors import DataFrameException
...
class DataFrame(object):
    ...
    def __getattr__(self, name):
        """
        Returns a :class:`types.Column <pandases.types.Column>` object denoted by ``name``.
        """
    ...
    def filter(self, condition):
        ...
        :param condition: :class:`BooleanFilter <pandases.operators.BooleanFilter>` object or a string
    ...
    def select(self, *cols):
        ...
        :param cols: list of column names or :class:`Column <pandases.types.Column>`.
    ...
    def groupby(self, *cols):
        ...
        :param cols: A list of column names, :class:`Column <pandases.types.Column>` or :class:`Grouper <pandases.operators.Grouper>` objects
        """
        columns = []
    ...
    def agg(self, *aggs):
        ...
        :param aggs: a list of :class:`Aggregator <pandases.operators.Aggregator>` objects
    ...
    def sort(self, *cols):
        ...
        :param cols: A list of column names, :class:`Column <pandases.types.Column>` or :class:`Sorter <pandases.operators.Sorter>`.
    ...
    def collect(self):
        ...
        :return: list of :class:`Row <pandases.types.Row>`
