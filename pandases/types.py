...
class Column(object):
    ...
    def isin(self, values):
        """
        Returns a :class:`BooleanFilter <pandases.operators.BooleanFilter>`

        :param values:  A list of values to filter terms
        :return: :class:`BooleanFilter <pandases.operators.BooleanFilter>`
    ...
    def ranges(self, values):
        """
        Returns a :class:`Grouper <pandases.operators.Grouper>`

        :param values: A list of numeric values
        :return: :class:`Grouper <pandases.operators.Grouper>`
    ...
    def isnull(self):
        """
        :class:`BooleanFilter <pandases.operators.BooleanFilter>` to indicate the null column value
    ...
    def notnull(self):
        """
        :class:`BooleanFilter <pandases.operators.BooleanFilter>` to indicate the non-null column value
    ...
    def desc(self, mode=None):
        """
        Descending :class:`Sorter <pandases.operators.Sorter>`

        :return: :class:`Sorter <pandases.operators.Sorter>`
    ...
    def asc(self, mode=None):
        """
        Ascending :class:`Sorter <pandases.operators.Sorter>`
    ...
    def max(self):
        ...
        :return: :class:`Aggregator <pandases.operators.Aggregator>`
...
class Row(tuple):
    """
    The builtin :class:`DataFrame <pandases.dataframe.DataFrame>` row type for accessing before converted into Pandas DataFrame.
